...
automl_run_id = 'olive_morning_508kplynkx_14'
...
def generate_data_transformation_config():
    ...
    column_group_3 = ['region']
    
    column_group_2 = ['sex', 'smoker']
    
    column_group_0 = [['age'], ['bmi'], ['children'], ['Claim_Amount'], ['past_consultations'], ['num_of_steps'], ['Hospital_expenditure'], ['NUmber_of_past_hospitalizations'], ['Anual_Salary']]
    
    column_group_1 = [['Claim_Amount']]
...
def generate_algorithm_config():
    ...
    algorithm = DecisionTreeRegressor(
        ...
        min_samples_leaf=0.2264309160659766,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--training_dataset_uri', type=str, default='azureml://locations/koreacentral/workspaces/2a448473-7ab7-4f14-b5be-24fe519988f1/data/insurance_dataset/versions/1',     help='Default training dataset uri is populated from the parent run')
